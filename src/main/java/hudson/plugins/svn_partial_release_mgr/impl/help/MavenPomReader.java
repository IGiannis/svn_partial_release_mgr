...
public final class MavenPomReader {
   ...
   *
   * @param groupId    Group ID - Cannot be <code>null</code>.
   * @param artifactId Artifact ID - Cannot be <code>null</code>.
   * @param version    Version - Cannot be <code>null</code>.
   * @param extension  File extension - Cannot be <code>null</code>.
   * @return Repository path.
   */
  public static String createPathAndFilename(final String groupId,
                                             final String artifactId,
  ...
  private static Object get(final Object src,
                            final String field) {
    try {
      return PluginUtil.reflectionCallMethod(src, toGetter(field), new Class[]{},
          new Object[]{});
    } catch (Exception ex) {
      try {
        return PluginUtil.reflectionCallMethod(src, toIs(field), new Class[]{},
            new Object[]{});
      } catch (Exception ex2) {
  ...
  private static void set(final Object dest,
                          final String field,
                          final Object value,
                          final Class clasz) {
    try {
      PluginUtil.reflectionCallMethod(dest, toSetter(field), new Class[]{clasz},
          new Object[]{value});
    } catch (Exception ex) {
  ...
  private static void set(final Object dest,
                          ...
                          final Object value) {
    try {
      PluginUtil.reflectionCallMethod(dest, toSetter(field), new Class[]{value.getClass()},
          new Object[]{value});
    } catch (Exception ex) {
  ...
  @SuppressWarnings("unchecked")
  private static void copyList(final List<Object> fromValue,
                               final Object to,
                               final String field) {
  ...
  private static void copyProperties(final Properties fromProps,
                                     final Object to,
                                     final String field) {
  ...
  @SuppressWarnings("unchecked")
  private static void copyObjectFields(final Object from,
                                       final Object to) {
  ...
  private static void copyObjectField(final Object fromValue,
                                      final Object to,
                                      final String field) {
  ...
  private static Model merge(final Model parent,
                             final Model child) {
   ...
   *
   * @param repositoryDir Repository path.
   ...
   * @param groupId       Group ID.
   * @param artifactId    Artifact ID.
   * @param version       Version - If <code>null</code> the latest version will be
   *                      used.
   * @return Model created from POM and Super-POM.
   */
  public static Model readModel(final File repositoryDir,
