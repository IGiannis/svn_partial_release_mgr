...
public class Constants {
  ...
  public static final String DEPLOYMENT_INFO_JSON_FILE_NAME = "deploymentInfo.json";
  ...
  public static final class JsonFileFilter implements FileFilter {
    @Override
    public boolean accept(File dir) {
      return (dir.isFile() && dir.getName().equalsIgnoreCase(DEPLOYMENT_INFO_JSON_FILE_NAME));
    }
  }
}
